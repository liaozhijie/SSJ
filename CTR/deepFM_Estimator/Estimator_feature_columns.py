...
from Estimator_input import create_embedding_matrix, embedding_lookup, get_dense_input, varlen_embedding_lookup, \
    get_varlen_pooling_list, mergeDict

from Estimator_layer_utils import Linear, concat_func
...
def input_from_feature_columns(features, feature_columns, l2_reg, seed=0, prefix='', seq_mask_zero=True,
